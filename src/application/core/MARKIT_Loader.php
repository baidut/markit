...
if (!defined('SAE_MYSQL_HOST_M')) {
	...
	// Fatal error: Cannot redeclare class CI_Loader in E:\xampp\htdocs\baidut\markit\src\system\core\Loader.php on line 29
	class_alias('CI_Loader', 'MARKIT_Loader');
} 
else {
 ...
 * @author		@月夜风KeN
 */
class MARKIT_Loader extends CI_Loader 
{
